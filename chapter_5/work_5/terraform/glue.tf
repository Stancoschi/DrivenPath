...
resource "aws_glue_crawler" "raw_driven_data_crawler" {
  ...
  s3_target {
    path = "${aws_s3_bucket.driven-data-bucket-stanco.bucket}/data/raw/"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_crawler" "staging_dim_address_crawler" {
  ...
  s3_target {
    path = "${aws_s3_bucket.driven-data-bucket-stanco.bucket}/data/staging/dim_address/"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_crawler" "staging_dim_date_crawler" {
  ...
  s3_target {
    path = "${aws_s3_bucket.driven-data-bucket-stanco.bucket}/data/staging/dim_date/"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_crawler" "staging_dim_finance_crawler" {
  ...
  s3_target {
    path = "${aws_s3_bucket.driven-data-bucket-stanco.bucket}/data/staging/dim_finance/"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_crawler" "staging_dim_person_crawler" {
  ...
  s3_target {
    path = "${aws_s3_bucket.driven-data-bucket-stanco.bucket}/data/staging/dim_person/"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_crawler" "staging_fact_network_usage_crawler" {
  ...
  s3_target {
    path = "${aws_s3_bucket.driven-data-bucket-stanco.bucket}/data/staging/fact_network_usage/"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_job" "staging_dim_address_glue" {
  ...
  command {
    name            = "pythonshell"
    python_version  = "3.9"
    script_location = "s3://${aws_s3_bucket.driven-data-bucket-stanco.bucket}/tasks/dim_address.py"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_job" "staging_dim_date_glue" {
  ...
  command {
    name            = "pythonshell"
    python_version  = "3.9"
    script_location = "s3://${aws_s3_bucket.driven-data-bucket-stanco.bucket}/tasks/dim_date.py"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_job" "staging_dim_finance_glue" {
  ...
  command {
    name            = "pythonshell"
    python_version  = "3.9"
    script_location = "s3://${aws_s3_bucket.driven-data-bucket-stanco.bucket}/tasks/dim_finance.py"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_job" "staging_dim_person_glue" {
  ...
  command {
    name            = "pythonshell"
    python_version  = "3.9"
    script_location = "s3://${aws_s3_bucket.driven-data-bucket-stanco.bucket}/tasks/dim_person.py"
  }
  tags = {
    Name = var.tag
  }
...
resource "aws_glue_job" "staging_fact_network_usage_glue" {
  ...
  command {
    name            = "pythonshell"
    python_version  = "3.9"
    script_location = "s3://${aws_s3_bucket.driven-data-bucket-stanco.bucket}/tasks/fact_network_usage.py"
  }
  tags = {
    Name = var.tag
  }
